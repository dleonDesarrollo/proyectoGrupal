<nav class="navbar bg-secondary-500">
  ...
  <ul class="navbar__main">
    ...
    <li class="navbar__item">
      <span class="navbar__icon material-icons">
      <span class="material-symbols-outlined">account_box</span>
      </span>
      <a class="navbar__link" href="#">Resumen</a>
    </li>

    <li class="navbar__item">
      <span class="material-icons">school</span>
      <a class="navbar__link" href="${pageContext.request.contextPath}/gestionusuarios?op=listar">Gestion Usuarios</a>
      <span class="material-icons caret">expand_more</span>
    </li>

    <li class="navbar__item">
      <span class="material-icons">diversity_3</span>
      <a onclick="toggle()" class="navbar__link" href="#">Gestion Pagos</a>
      <span class="material-icons caret">expand_more</span>
    </li>

    <li class="navbar__item">
      <span class="material-icons">medical_services</span>
      <a onclick="toggle()" class="navbar__link" href="#">Chequeos</a>
      <span class="material-icons caret">expand_more</span>
    </li>
